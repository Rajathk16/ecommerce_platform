    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-md animate-fade-in space-y-6 rounded-3xl border border-slate-200 bg-white px-8 py-10 shadow-2xl">
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-sm text-slate-500">Join HugyShopy today!</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-500">
          ...
          <Link href="/Login" className="font-semibold text-black underline underline-offset-2 hover:text-slate-600">
            Login
          </Link>
        </p>
      </div>
